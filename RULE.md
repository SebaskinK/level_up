...
三副牌总分 300 分，60 分为一级。下表是**正常局（2 打 3）**的升级概览。
独打局（1 打 4）抓分方与本表相同，只有庄家升级时翻 3 倍，详见 7.3。

| 抓分范围 | 等级变化 | 说明 |
|----------|----------|------|
| 0 分 | 庄家方升 3 级 | 大光 |
| 1 - 59 分 | 庄家方升 2 级 | 小光 |
| 60 - 119 分 | 庄家方升 1 级 | 小胜 |
| 120 - 179 分 | 抓分方升 1 级 | 抓分方上台 |
| 180 - 239 分 | 抓分方升 2 级 | 抓分方大胜 |
| 240 - 299 分 | 抓分方升 3 级 | 抓分方完胜 |
| 300 分 | 抓分方升 4 级 | 抓分方满光 |

> 每一档只有获胜的一方升级，落败一方不升级。详见 7.2 与 7.3。
...
规则：**庄家升级时，级数按正常局翻 3 倍；抓分方升级级数与正常局相同。**

| 抓分范围 | 结果 | 庄家升级 | 抓分方升级 |
|----------|------|----------|------------|
| 0 分 | 大光 | 升 9 级（3×3） | 不升级 |
| 1 - 59 分 | 小光 | 升 6 级（2×3） | 不升级 |
| 60 - 119 分 | 小胜 | 升 3 级（1×3） | 不升级 |
| 120 - 179 分 | 反超 | 不升级 | 每人升 1 级 |
| 180 - 239 分 | 大胜 | 不升级 | 每人升 2 级 |
| 240 - 299 分 | 完胜 | 不升级 | 每人升 3 级 |
| 300 分 | 满光 | 不升级 | 每人升 4 级 |

> 翻倍只作用于庄家：一个人扛四个人，赢了多拿，输了也不会让对面多拿。
...
- **升过 A**：一局升的级数越过 A 时不截断，从 2 接着往上循环。
  例：打 Q 的玩家升 3 级 → K → A → **2**
